 ...
 */
class SettingCompanySecret extends PlenigoWPSetting
{

    //These should be overriden
    const SECTION_ID = 'plenigo_general';
    const SETTING_ID = 'company_secret';
    ...
    {
        return __('Company Private Key', parent::PLENIGO_SETTINGS_GROUP);
    }
    ...
    public function renderCallback()
    {
        ...
        printf(
            '<input type="text" id="company_secret" name="' . self::PLENIGO_SETTINGS_NAME
            . '[company_secret]" value="%s" size="85" />',
            esc_attr($currValue) 
        );
    }
